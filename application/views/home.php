...
?>
	...
	<div id="header">
		...
		<span id="logosignature">
			TxtConnect
			<span class="userlogout" ng-click="logout()" style="float:right">| Logout</span>
			<span class="userinfo" style="float:right;" ng-click="changepassword()"><?php echo $fullname; ?> &nbsp;</span>
		</span>
		<div id="hdrtabs">
			<!--<span id="home" data-ripple ng-click="hometab()">HOME</span>-->
			<span id="msg" data-ripple ng-click="msgtab()">MESSAGES</span>
			<span id="pbook" data-ripple ng-click="pbtab()">PHONEBOOK</span>
			<span ng-show="adminmodule == 1" id="rptgroup" data-ripple ng-click="rptgrptab()">REPORT GROUPS</span>
			<span ng-show="adminmodule == 1" id="users" data-ripple ng-click="usertab()">USERS</span>
